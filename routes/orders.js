...
router.post('/place', async (req, res) => {
    try {
        ...
        try {
            ...
            try {
                let joadminUrl = process.env.JOADMIN_SERVER_URL || 'https://padmin121-1.onrender.com';
                if (joadminUrl.includes('padmin121.onrender.com') && !joadminUrl.includes('padmin121-1.onrender.com')) {
                    joadminUrl = joadminUrl.replace('padmin121.onrender.com', 'padmin121-1.onrender.com');
                }
            ...
            // Discount feature removed — no holiday discount applied to totalCostEtb
